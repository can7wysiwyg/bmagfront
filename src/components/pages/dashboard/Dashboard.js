        ...
        <div className="col my-3">
            ...
            <div className="col my-3">
                <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                        <div className="text-primary mb-5">
                        <i className="bi bi-camera" style={{fontSize: "70px"}}></i>


                           
                        </div>
                        <h6 className="font-weight-bold mb-3">VIDEO SUBSCRIPTIONS</h6>
                        <p className="text-muted mb-0"><a href="/video_subscriptions"> check video subscriptions</a></p>
                    </div>
                </div>
            </div>
            {/* user bar end */}
