    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/update_article_photo/:id"
            element={<UpdateArticlePhoto />}
          />
          <Route
            path="/edit_article_content/:id"
            element={<EditArticleContent />}
          />
          <Route
            path="/edit_article_author/:id"
            element={<EditArticleAuthor />}
          />
          <Route
            path="/edit_article_title/:id"
            element={<EditArticleTitle />}
          />
          ...
          <Route
            path="/edit_magissue_name/:id"
            element={<EditMagIssueName />}
          />
          <Route
            path="/update_magaissue_pdffile/:id"
            element={<UpdateMagaPdf />}
          />
          <Route
            path="/update_magaissue_cover/:id"
            element={<UpdateMagaCover />}
          />
          ...
          <Route
            path="/magazine_subscriptions"
            element={<MagazineSubscriptions />}
          />
          <Route
            path="/subscription_token/:id"
          ...
          <Route
            path="/video_subscription_token/:id"
            element={<VideoSubscriptionToken />}
          />
          <Route
            path="/watch_subscribed_video/:id"
            element={<WatchSubscribedVideo />}
          />
          <Route
            path="/check_video_subscriber/:id"
            element={<CheckVideoSubscriber />}
          />
          <Route
            path="/watch_my_subscribed_videos"
            element={<MySubscribedVideos />}
          />
